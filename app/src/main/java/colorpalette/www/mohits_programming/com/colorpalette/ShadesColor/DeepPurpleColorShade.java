...
public class DeepPurpleColorShade extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deep_purple_color_shade);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                Toast.makeText(DeepPurpleColorShade.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
            }
        });
