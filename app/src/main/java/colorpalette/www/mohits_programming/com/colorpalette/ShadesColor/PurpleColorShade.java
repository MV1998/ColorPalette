...
public class PurpleColorShade extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_purple_color_shade);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                Toast.makeText(PurpleColorShade.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
            }
        });
