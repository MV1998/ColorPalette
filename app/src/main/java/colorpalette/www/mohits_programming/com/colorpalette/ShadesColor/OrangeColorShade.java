...
public class OrangeColorShade extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orange_color_shade);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                Toast.makeText(OrangeColorShade.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
            }
        });
