...
public class IndigoColorShade extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indigo_color_shade);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                Toast.makeText(IndigoColorShade.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
            }
        });
