...
public class BlueColorShade extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blue_color_shade);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                Toast.makeText(BlueColorShade.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
            }
        });
